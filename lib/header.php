...
<html>
    <head>
        <title>Enrich.data by SDG</title>
		...
		<link rel="icon" type="image/png" sizes="32x32" href="https://www.seendigital.asia/dashboard/images/favicon-32x32.png">
...
})(window,document,'script','dataLayer','GTM-N7XGRSC');</script>
    ...
    <body class="bg-light">
        ...
        <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
            <div class="my-0 mr-md-auto font-weight-normal">
                <span><img src="https://www.seendigital.asia/dashboard/images/seen_logo_web.png" style="width:80px"></span>
                <span><img src="https://www.seendigital.asia/dashboard/images/verti-bar.png" style="height:38px"></span>
                <span><img src="https://www.seendigital.asia/dashboard/images/enrich_data_logo.png" style="height:38px"></span>
            </div>
            ...
            <nav class="my-2 my-md-0 mr-md-3">
                ...
                <button type="button" class="btn btn-outline-secondary btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item active" href="https://www.seendigital.asia/dashboard/SDG0001">SDG0001</a>
                            ...
                            <a class="dropdown-item active" href="#">PB190013 BITEC</a>
							<a class="dropdown-item" href="https://www.seendigital.asia/dashboard/PB190014">|__PB190014 TME2020</a>
                    ...
                    <button type="button" class="btn btn-outline-secondary btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="https://www.seendigital.asia/dashboard/admin/project_tracker.php"> Project Tracker</a>
